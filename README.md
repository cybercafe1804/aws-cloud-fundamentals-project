# AWS Secure and Scalable Web Infrastructure

## Overview

This project shows how I built a secure and scalable web environment in AWS. I configured network security, IAM permissions, S3 replication, EC2 deployment, automatic scaling, and load balancing.

I finished by opening the hosted web page in a browser to confirm the environment was working.
...
I also configured S3 cross-region replication to copy objects to a bucket in another AWS Region.

## Project Steps

### 1. Configure the Web Security Group
...
I created an Auto Scaling group with a desired capacity of two instances and a scaling range of two to four instances.
...
Passwords, credentials, account identifiers, and other sensitive information were removed from the project.
